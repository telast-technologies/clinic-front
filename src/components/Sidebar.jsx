...
const Sidebar = (props) => {
  ...
  const handleClick = (e, item, item1, item3) => {
    ...
    if (window.innerWidth <= 768) {
      document.querySelector("#mobile_btn").click();
    }
  };
            ...
            >
              <ul>
                ...
                <li className="submenu">
                  ...
                  >
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "appointment-dashboard"
                            ? "active"
                            : ""
                        }
                ...
                <li className="submenu">
                  ...
                  {props?.activeClassName === "PatientProfile" && (
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "PatientProfile" ? "active" : ""
                        }
                      >
                        Patients Profile
                      </Link>
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items3">
                    ...
                    {props?.activeClassName === "edit-staff" && (
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "edit-staff"
                    ...
                    {props?.activeClassName === "staff-profile" && (
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "staff-profile-temp"
                              ? "active"
                              : ""
                          }
                          to="/staff-profile-temp"
                        >
                          Staff Profile Temp
                        </Link>
                      </li>
                ...
                <li className="submenu">
                  ...
                  >
                    ...
                    <span> Visits </span> <span className="menu-arrow" />
                  </Link>
                  <ul style={{ display: "none" }} className="menu-items4">
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "TimeSlot"
                            ? "active"
                            : ""
                        }
                        to="/timeslot"
                      ...
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "AddTimeSlot"
                              ? "active"
                              : ""
                          }
                          to="/addtimeslot"
                    ...
                    {props?.activeClassName === "EditTimeSlot" && (
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "EditTimeSlot"
                ...
                <li className="submenu">
                  ...
                  >
                    ...
                    <span> Assets</span> <span className="menu-arrow" />
                  </Link>
                  <ul style={{ display: "none" }} className="menu-items11">
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "Services" ? "active" : ""
                        }
                        to="/services"
                      >
                        Services
                    ...
                    {props?.activeClassName === "AddService" && (
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "AddService" ? "active" : ""
                          }
                        >
                          Add Service
                        </Link>
                    ...
                    {props?.activeClassName === "EditService" && (
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "EditService" ? "active" : ""
                          }
                        >
                          Edit Service
                        </Link>
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "Supplies" ? "active" : ""
                        }
                        to="/supplies"
                      >
                        Supplies
                    ...
                    {props?.activeClassName === "AddSupply" && (
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "AddSupply" ? "active" : ""
                          }
                        >
                          Add Supply
                        </Link>
                    ...
                    {props?.activeClassName === "EditSupply" && (
                      <li>
                        <Link
                          className={
                            props?.activeClassName === "EditSupply" ? "active" : ""
                          }
                        >
                          Edit Supply
                        </Link>
